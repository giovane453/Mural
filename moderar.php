...
if(isset($_GET['excluir'])) {
    ...
    $res = mysqli_query($conexao, "SELECT imagem_url FROM recados2 WHERE id = $id");
    ...
    mysqli_query($conexao, "DELETE FROM recados2 WHERE id = $id") or die("Erro ao excluir: " . mysqli_error($conexao));
...
$produtos = mysqli_query($conexao, "SELECT * FROM recados2 ORDER BY id DESC");
